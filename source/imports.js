...
addImportedModules({
	...
	// direct dependencies of metro-react-native-babel-preset
	'@babel/plugin-proposal-class-properties': () => require('@babel/plugin-proposal-class-properties'),
    '@babel/plugin-proposal-export-default-from': () => require('@babel/plugin-proposal-export-default-from'),
    '@babel/plugin-proposal-nullish-coalescing-operator': () => require('@babel/plugin-proposal-nullish-coalescing-operator'),
    '@babel/plugin-proposal-object-rest-spread': () => require('@babel/plugin-proposal-object-rest-spread'),
    '@babel/plugin-proposal-optional-catch-binding': () => require('@babel/plugin-proposal-optional-catch-binding'),
    ...
    '@babel/plugin-syntax-export-default-from': () => require('@babel/plugin-syntax-export-default-from'),
    ...
    '@babel/plugin-transform-typescript': () => require('@babel/plugin-transform-typescript'),
